    ...
    >
      ...
      <div className="flex-1 py-4">
        {currentDisplayList.length === 0 ? (
          ...
          <div className={{
            'grid': "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4 pb-6",
            'compact': "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 pb-6",
            'list': "flex flex-col gap-3 sm:gap-4 pb-6"
          }[layout]}>
            <AnimatePresence>
